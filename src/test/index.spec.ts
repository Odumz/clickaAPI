...
describe('Post route tests', () => {
    ...
    it('should not add new userplan data if feature is missing', async () => {
    ...
    it('should not add data to the userplan data if name is less than 3 characters', async () => {
        const res = await request(app)
            .post('/api/v1/userplans/add')
            .send({
                name: 'Te',
    ...
    it('should add data to the user data', async () =>{
        const res = await request(app)
    ...
    it('should not add data to the user data if name is missing', async () => {
        const res = await request(app)
            .post('/api/v1/users/add')
            .send({
                email: 'test1@taast.test',
    ...
    it('should not add data to the user data if email is missing', async () => {
        const res = await request(app)
            .post('/api/v1/users/add')
            .send({
                name: 'Test1',
    ...
    it('should not add data to the user data if phone is missing', async () => {
        const res = await request(app)
            .post('/api/v1/users/add')
            .send({
                name: 'Test1',
    ...
    it('should not add data to the user data if userplan id is missing', async () => {
        const res = await request(app)
            .post('/api/v1/users/add')
            .send({
                name: 'Test1',
    ...
    it('should not add data to the user data if phone number is less than 10', async () => {
        const res = await request(app)
            .post('/api/v1/users/add')
            .send({
                name: 'Test1',
    ...
    it('should not add data to the user data if email format is wrong', async () => {
        const res = await request(app)
            .post('/api/v1/users/add')
            .send({
                name: 'Test1',
    ...
    it('should not add data to the user data if name is less than 3 characters', async () => {
        const res = await request(app)
            .post('/api/v1/users/add')
            .send({
                name: 'Te',
    ...
    it('should not add data to the user data if userplan id is less than 24 characters', async () => {
        const res = await request(app)
            .post('/api/v1/users/add')
            .send({
                name: 'Test1',
                email: 'test1aast.test',
                phone: '136491523567',
                userplan: ['6146ff7492503f63671622']
            });
        expect(res.status).to.be.equal(400);
        expect(res.body).to.be.empty;
    });
    it('should add data to the userplan data', async () => {
        const res = await request(app)
            .post('/api/v1/userplans/add')
            .send({
                name: 'Test1'
        ...
        expect(res.status).to.be.equal(201);
        expect(res.body).not.to.be.empty;
        expect(res.body).to.have.a.property('message').equal('UserPlan successfully created');
        expect(res.body.userplan).to.be.an('object');
    });
    it('should not add data to the userplan data if name is missing', async () => {
        const res = await request(app)
            .post('/api/v1/userplans/add')
            .send({});
        expect(res.status).to.be.equal(400);
...
describe('Duplicate post route tests', () => {    
    it('should not add data to the user data if email is a duplicate', async () => {
        const res = await request(app)
            .post('/api/v1/users/add')
            .send({
                name: 'Test1',
    ...
    it('should not add data to the userplan data if name is a duplicate', async () => {
        const res = await request(app)
            .post('/api/v1/userplans/add')
            .send({
                name: 'Test1'
        ...
        userplan.save((err, userplan) => {
            ...
            request(app)
                ...
                .end((err, res) => {
                    ...
                    expect(res.body).not.to.be.empty;
                    expect(res.body).to.have.a.property('status').equal('success');
                    expect(res.body).to.have.a.property('message').equal('UserPlan successfully fetched');
